  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-full h-[850px] bg-[#A88B65] p-10 flex flex-col">
        ...
        <nav className="flex justify-center items-center pb-6">
          <div className="space-x-8 text-lg flex">
            ...
            <a
              ...
              className="text-gray-800 hover:text-[#B43B26] font-bold"
            >
              HOME
            </a>
            ...
            <a
              href="#"
              className="text-white hover:text-[#B43B26] font-bold"
            >
              DASHBOARD
            </a>
        ...
        {/* Main Content */}
        <motion.h1
          className="text-center py-12 px-4 text-white text-3xl lg:text-4xl font-bold mb-8"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
        >
          Welcome! Your next big event is just a few clicks away.
          <br />
          Let’s get started!
        </motion.h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl mx-auto">
          ...
          >
            ...
            <h3 className="text-lg font-semibold mb-4">
              Create Your Perfect Event Theme
            </h3>

            <img
              src="/src/Pictures/theme.jpg"
              alt="Event Theme Generator"
              className="w-full h-48 object-cover rounded-lg mb-4"
            />

            <p className="text-base mb-4">
              Discover AI-crafted event themes that perfectly match your
              vision, budget, and guest list.
            </p>
          ...
          >
            ...
            <img
              src="/src/Pictures/vendor.jpg"
              alt="Vendor Marketplace"
              className="w-full h-48 object-cover rounded-lg mb-4"
            />

            <p className="text-base mb-4">
              Browse and book verified vendors for your event needs,
              from caterers to photographers.
            </p>
          ...
          >
            ...
            <img
              src="/src/Pictures/budget.jpg"
              alt="Budget Tracker"
              className="w-full h-48 object-cover rounded-lg mb-4"
            />

            <p className="text-base mb-4">
              Plan smarter with a dynamic budget tracker that updates
              as you finalize vendors and costs.
            </p>
